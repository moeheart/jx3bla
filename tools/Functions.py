...
def getOccType(occ):
    ...
    '''
    if occ in ['1t', '3t', '10t', '21t', '1tw', '3tw', '10tw', '21tw']:
        return "tank"
    elif occ in ['2h', '5h', '6h', '22h', '212h', '2hw', '5hw', '6hw', '22hw', '212hw']:
        return "healer"
    else:
        return "dps"
...
def getOccDetailFromXinfaCode(xinfaCode):
    XINFA_CODE_TO_OCCDETAIL = {
        "10003": "1d",
        "10002": "1t",
        "10015": "4p",
        "10014": "4m",
