...
(TODO)白帝江关1号，统计AOE，单独点名，代码转换。

白帝江关2号，包括有效时间计算(done)，AOE(done)，单独点名(done)。

(TODO)白帝江关3号，统计战斗阶段，代码转换。

(TODO)白帝江关4号，统计AOE，战斗阶段。
...
(TODO)修复测试服如果装备了新的大附魔，会把整个流程卡住的问题。现在用一种通用的方法来为未识别的装备保底。
