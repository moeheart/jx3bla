...
function GetSkillLevelData(A0_0)
  ...
  A0_0.AddAttribute(ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK, ATTRIBUTE_TYPE.SET_TALENT_RECIPE, 4089, 1)
  ...
  A0_0.AddAttribute(ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK, ATTRIBUTE_TYPE.SKILL_EVENT_HANDLER, 412, 0)
  A0_0.AddAttribute(ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK, ATTRIBUTE_TYPE.SKILL_EVENT_HANDLER, 363, 0)
  A0_0.AddAttribute(ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK, ATTRIBUTE_TYPE.EXECUTE_SCRIPT, "skill/藏剑/藏剑_套路_内功_山居剑意.lua", 0)
...
function OnSkillLevelUp(A0_4, A1_5)
  ...
  A1_5.LearnSkillLevel(1728, L3_7, A1_5.dwID)
  A1_5.LearnSkill(1729)
end
function Apply(A0_8)
  ...
  if GetPlayer(A0_8).GetBuff(9900, 1) then
    GetPlayer(A0_8).DelBuff(9900, 1)
  end
end
