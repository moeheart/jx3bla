Include("scripts/Map/蓬莱/npc/九歌岛/胡惕.lua")
...
function GetSkillLevelData(A0_0)
  ...
  A0_0.AddAttribute(ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK, ATTRIBUTE_TYPE.DST_NPC_DAMAGE_COEFFICIENT, tSkillKungfuConst.LOGIC.NPC[10533], 1)
  A0_0.AddAttribute(ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK, ATTRIBUTE_TYPE.MAX_QI_ENERGY, tSkillKungfuConst.LOGIC.QI[10533].MAX, 0)
  A0_0.AddAttribute(ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK, ATTRIBUTE_TYPE.QI_ENERGY_REPLENISH, tSkillKungfuConst.LOGIC.QI[10533].REPLENISH, 0)
  ...
  A0_0.AddAttribute(ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK, ATTRIBUTE_TYPE.EXECUTE_SCRIPT_WITH_PARAM, "skill/蓬莱/蓬莱_套路_内功_输出心法.lua", L3_3)
...
function OnSkillLevelUp(A0_6, A1_7)
  ...
  A1_7.LearnSkillLevel(19706, A0_6.dwLevel, A1_7.dwID)
end
function Apply(A0_8, A1_9, A2_10)
  if GetPlayer(A0_8) then
    ...
    if not GetPlayer(A0_8).IsHaveBuff(32217, 1) then
      GetPlayer(A0_8).AddBuff(0, 99, 32217, 1)
      GetPlayer(A0_8).SetTimer(16, "scripts/skill/蓬莱/蓬莱_套路_内功_输出心法.lua", 0, 0)
    end
  end
end
