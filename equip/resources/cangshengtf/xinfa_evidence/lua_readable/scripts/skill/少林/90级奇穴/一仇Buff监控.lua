...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if not npc or npc.nMoveState == MOVE_STATE.ON_DEATH then
		player.DelBuffByID(17885)
		player.DelBuffByID(29938)
	end
end
...
--通道技开始
function OnChannelBegin(caster)   --参数释放者
end

--通道技结束
function OnChannelEnd(caster, bIsComplete)  --参数1释放者  参数2是否正常结束
end
