...
class AttributeData():
    ...
    def __init__(self, occ='2d'):
        ...
        self.baseAttrib = {
            ...
            '防御': 0.044046832497038745, '会心': 0.17937040923399789, '加速': 0.0037519271379895577, '破招': 18165,
            '身法': 38.0, '元气': 7114.0, '根骨': 38.0, '招架': 0.03, '会心效果': 1.75, '会效': 1.75, '基础攻击': 16554.0, '基础治疗': 0,
